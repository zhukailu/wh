...
<script type="text/javascript">
	...
	$(function(){
		...
		window.open("workbench/Inf/InfIndex.do","workareaFrame");
...
<body>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">仓库管理 &nbsp;<span style="font-size: 12px;">业务界面 &nbsp;</span></div>
...
<%--				<li class="liClass"><a href="workbench/activity/indexActivity.do" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>--%>
...
<%--				<li class="liClass"><a href="javascript:void(0);" target="workareaFrame"><span class="glyphicon glyphicon-shopping-cart"></span> 销售订单</a></li>--%>
				<li class="liClass"><a href="workbench/Inf/InfIndex.do" target="workareaFrame"><span class="glyphicon glyphicon-leaf"></span> 产品信息</a></li>
				<li class="liClass"><a href="workbench/operate/OperateIndex.do" target="workareaFrame"><span class="glyphicon glyphicon-earphone"></span> 出库/入库</a></li>
				<li class="liClass"><a href="workbench/operate/OperateInfList.do" target="workareaFrame"><span class="glyphicon glyphicon-send"></span> 操作历史</a></li>
				<li class="liClass"><a href="workbench/test/testIndex.do" target="workareaFrame"><span class="glyphicon glyphicon-usd"></span> 产品类型</a></li>
			</ul>
