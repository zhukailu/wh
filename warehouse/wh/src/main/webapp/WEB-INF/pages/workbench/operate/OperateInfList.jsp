    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $("#editActivityBtn").click(function () {
                ...
                var operateId=chkedIds[0].value;
                //发送请求
                $.ajax({
                    url:'workbench/operate/queryOperateInfById.do',
                    data:{
                        operateId:operateId
                    },
                    type:'post',
                    ...
                    success:function (data) {
                        //把市场活动的信息显示在修改的模态窗口上
                        $("#create-productName").val(data.operate.operateProductName);
                        $("#create-operateName").val(data.operate.operateType);
                        $("#create-operateNum").val(data.operate.operateNum);
                        $("#create-operateUser").val(data.user.userName);
                        $("#create-operateTime").val(data.operate.operateTime);
                        $("#create-remarks").val(data.operate.operateRemarks);
                        //弹出模态窗口
        ...
        function queryActivityByConditionForPage(pageNo,pageSize) {
            ...
            var user=$("#query-user").val();
            var date=$("#query-date").val();
            var product=$("#query-product").val();
            //var pageNo=1;
            //var pageSize=10;
            //发送请求
            $.ajax({
                url:'workbench/operate/queryOperateInf.do',
                data:{
                    type:type,
                    user:user,
                    date:date,
                ...
                success:function (data) {
                    ...
                    $.each(data.list,function (index,obj) {
                        ...
                        htmlStr+="<td><input type=\"checkbox\" value=\""+obj.operateId+"\"/></td>";
                        // htmlStr+="<td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href='workbench/activity/detailActivity.do?id="+obj.id+"'\">"+obj.name+"</a></td>";
                        htmlStr+="<td>"+obj.operateTime+"</td>";
                        htmlStr+="<td>"+obj.operateProductName+"</td>";
                        htmlStr+="<td>"+obj.operateType+"</td>";
                        htmlStr+="<td>"+obj.operateNum+"</td>";
                        htmlStr+="</tr>";
                    });
                    $("#tBody").html(htmlStr);
    ...
    <div class="modal-dialog" role="document" style="width: 85%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel1">详细</h4>
            </div>

            <div class="modal-body">
                <form id="createActivityForm" class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="create-productName" class="col-sm-2 control-label">产品名称</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-productName">
                        </div>
                        <label for="create-operateName" class="col-sm-2 control-label">操作类型</label>
                        <div class="col-sm-10" style="width: 300px;">
                    ...
                    <div class="form-group" id="colorAndCapacity">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-operateUser">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="create-operateTime" class="col-sm-2 control-label">操作时间<span style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-operateTime">
                        </div>
            ...
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" id="query-user">
                    </div>
                </div>
...
<%--                        <input class="form-control" type="text" id="query-startDate" />--%>
                        <input type="text" class="form-control mydate" name="mydate" id="query-date" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">产品</div>
                        <input class="form-control" type="text" id="query-product">
                    </div>
                </div>
        ...
        <div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
            <div class="btn-group" style="position: relative; top: 18%;">
                <button type="button" class="btn btn-default" id="editActivityBtn"><span class="glyphicon glyphicon-pencil"></span> 详细</button>
            </div>
            <div class="btn-group" style="position: relative; top: 18%;">
